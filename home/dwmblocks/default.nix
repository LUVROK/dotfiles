...
let
  ...
  dbXkb = pkgs.writeShellApplication {
    ...
    text = builtins.readFile ./scripts/db-xkb;
    checkPhase = ":";
  };
  ...
  dbBattery = pkgs.writeShellApplication {
    ...
    text = builtins.readFile ./scripts/db-battery;
    checkPhase = ":";
  };
  ...
  dbDate = pkgs.writeShellApplication {
    ...
    text = builtins.readFile ./scripts/db-date;
    checkPhase = ":";
  };
  ...
  dbMemory = pkgs.writeShellApplication {
    ...
    text = builtins.readFile ./scripts/db-memory;
    checkPhase = ":";
  };
  ...
  dbVolume = pkgs.writeShellApplication {
    ...
    text = builtins.readFile ./scripts/db-volume;
    checkPhase = ":";
  };
  ...
  dbWifi = pkgs.writeShellApplication {
    ...
    text = builtins.readFile ./scripts/db-wifi;
    checkPhase = ":";
  };
in
{
