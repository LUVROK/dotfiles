...
function _xrandr-hdmi-1-0() { xrandr --output HDMI-1-0 --mode 1920x1080 --rate 60.00 --right-of eDP-1 && feh --geometry 3456x2160+0+0 --auto-zoom --randomize --bg-fill /home/dash/HOME/wizzard/wallpaper/antiquity* > /dev/null 2>&1 & }
function _xrandr-hdmi-1-0-output() { xrandr --output HDMI-1-0 --off & }
function _ps_aux_grep() { ps aux | grep $1 > /dev/null 2>&1 & }
